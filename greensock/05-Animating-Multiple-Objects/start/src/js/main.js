(function($) {
	...
	tl
		...
		.from(intro, 1, {y: -15, autoAlpha: 0, ease: Power1.easeOut}, "-=0.5")
		.from(img, 1, {y: -15, autoAlpha: 0, ease: Power1.easeOut}, "-=0.5")
		.from(h2, 1, {y: -15, autoAlpha: 0, ease: Power1.easeOut}, "-=0.5")
		.from(listItem, 1, {y: -15, autoAlpha: 0, ease: Power1.easeOut}, "-=0.5");
})(jQuery);